export class Maths {
   ...
   * @throws {Error} "unsafe argument" if input contains number out of range
   * [{@link Number.MIN_SAFE_INTEGER}, {@link Number.MAX_SAFE_INTEGER}] or start is out of range
   * [0, {@link Number.MAX_SAFE_INTEGER}] or length is out of range [1, {@link Number.MAX_SAFE_INTEGER}]
   */
